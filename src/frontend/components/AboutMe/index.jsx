...
const description = `I've always known that I would be a developer even if it takes me 10 years longer than others. It's with that mentality that I started do study code in the past 5 years.`;
...
export default () => (
  <StyledDiv>
    ...
    <GridContainer>
      <LogoContainer />
      <Container>
        <NameContainer>WILL TING</NameContainer>
